...
function RightSidebar(props) {
    return (
        <>
            <div className="shadow-2xl px-0 bg-white h-full overflow-hidden absolute top-16 right-0" style={props.RightNavCloseStatus==false?{'width':'225px','transition':'0.4s'}:{'width':'0','transition':'0.4s'}}>
